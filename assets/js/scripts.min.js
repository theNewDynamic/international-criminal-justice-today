...
$.ajax({url:"http://api.tumblr.com/v2/blog/aba-icc.tumblr.com/posts?api_key=712yUR7HNAL8B8YXhrRwvH3sCnAgjV74BlYezAD8KWtbtXM9Ij&limit=1",dataType:"jsonp",success:function(t){$.each(t.response.posts,function(t,l){var e=(l.caption,l.body,l.text),n=l.description,o=l.source_title,o=l.source_title;l.title&&l.post_url?$('<h4><a href="'+l.url+'" target="_blank">'+l.title+'</a> <small><i class="icon-link-ext" style="font-size:.625em;"></i></small> </h4>').appendTo("#content_tumblr"):l.title&&$("<h4>"+l.title+"</h4>").appendTo("#content_tumblr"),l.description&&$("<p>"+n+"</p>").appendTo("#content_tumblr"),l.text&&$("<blockquote><em><small>"+e+"</small></em></blockquote>").appendTo("#content_tumblr"),l.source&&$("<small>&mdash;"+e+"</small>").appendTo("#content_tumblr"),l.source_title&&$("<br /><small><strong>"+o+"</strong></small>").appendTo("#content_tumblr"),l.urlTK&&$('<a href="'+l.url+'" target="_blank">LINK</a>').appendTo("#content_tumblr"),$("<hr />").appendTo("#content_tumblr")})}}),$.ajax({url:"http://api.tumblr.com/v2/blog/aba-icc.tumblr.com/posts?api_key=712yUR7HNAL8B8YXhrRwvH3sCnAgjV74BlYezAD8KWtbtXM9Ij&limit=10&offset=1",dataType:"jsonp",success:function(t){$('<div style="display:none;" id="tumblr-extended">').appendTo("#content_tumblr-long"),$.each(t.response.posts,function(t,l){var e=(l.caption,l.body,l.text),n=l.description,o=l.source_title,o=l.source_title;l.title&&l.post_url?$('<h4><a href="'+l.url+'" target="_blank">'+l.title+'</a> <small><i class="icon-link-ext" style="font-size:.625em;"></i></small> </h4>').appendTo("#content_tumblr-long"):l.title&&$("<h4>"+l.title+"</h4>").appendTo("#content_tumblr-long"),l.description&&$("<p>"+n+"</p>").appendTo("#content_tumblr-long"),l.text&&$("<blockquote><em><small>"+e+"</small></em></blockquote>").appendTo("#content_tumblr-long"),l.source&&$("<small>&mdash;"+e+"</small>").appendTo("#content_tumblr-long"),l.source_title&&$("<br /><small><strong>"+o+"</strong></small>").appendTo("#content_tumblr-long"),l.urlTK&&$('<a href="'+l.url+'" target="_blank">LINK</a>').appendTo("#content_tumblr-long"),$("<hr />").appendTo("#content_tumblr-long")}),$("</div>").appendTo("#content_tumblr-long")}});
